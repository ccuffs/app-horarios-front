          ...
          <FormControl sx={{ minWidth: 200 }}>
            ...
            >
              ...
              {cursos.length === 0 && !loadingCursos && (
                <MenuItem disabled>Nenhum curso encontrado</MenuItem>
              )}
            </Select>
          </FormControl>
      ...
      {isLoading ? (
        ...
        <>
          {selectedCurso && Object.keys(events).length === 0 && !loadError && (
            <Alert severity="info" sx={{ mb: 2 }}>
              Nenhum horário cadastrado para {selectedCurso.nome} no período{" "}
          ...
          {selectedCurso &&
            ...
            Object.keys(events).length === 0 && (
              <Alert severity="warning" sx={{ mb: 2 }}>
                Nenhuma oferta de fase cadastrada para este curso no período
                selecionado.
              </Alert>
            )}
