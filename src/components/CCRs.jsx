...
export default function CCRs() {
  ...
  function handleEdit(data) {
    ...
    const cursosIds = data.cursos ? data.cursos.map((curso) => curso.id) : [];
  ...
  function handleCursosChange(event) {
    ...
    setCursosSelecionados(typeof value === "string" ? value.split(",") : value);
  }
        ...
        <Stack spacing={2}>
          ...
          <FormControl size="small" fullWidth>
            ...
            <Select
              ...
              input={<OutlinedInput id="select-cursos" label="Cursos" />}
